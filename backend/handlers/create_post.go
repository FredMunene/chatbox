...
func CreatePost(w http.ResponseWriter, r *http.Request) {
	...
	id, err := repositories.InsertRecord(util.Database, "tblPosts", []string{"post_title", "body", "media_url", "user_id"}, html.EscapeString(r.FormValue("post-title")), html.EscapeString(r.FormValue("post-content")), url, sessionData["userId"].(int))
	if err != nil {
	...
	for _, category := range categories {
		repositories.InsertRecord(util.Database, "tblPostCategories", []string{"post_id", "category"}, id, category)
	}
